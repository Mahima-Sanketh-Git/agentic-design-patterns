...
|  |- images/
|  |  |- linear.png
|  |  |- hierarchical_single_root.png
|  |  |- deep_hierarchical_communication.png
|  |  |- all_to_all.png
|  |- marketing-article-writing-agent/
|- agent-reflection/
|  |- example_1/
|  |  |- agent_reflection.py
|  |  |- requirements.txt
...
For this repository, follow the concepts in this order:
1. Reflection
2. Tool Selection
3. Planning
...
The current repository already includes generated visual examples under `agent-multi-agent/images/`.

### Visual examples

All communication patterns are shown below:

- **Linear (chain):**

   ![Linear](agent-multi-agent/images/linear.png)

- **Hierarchical (single-root):**

   ![Hierarchical](agent-multi-agent/images/hierarchical_single_root.png)

- **Deep hierarchical (nested):**

   ![Deep hierarchical](agent-multi-agent/images/deep_hierarchical_communication.png)

- **All-to-all (fully connected):**

   ![All-to-all](agent-multi-agent/images/all_to_all.png)
